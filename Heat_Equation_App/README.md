...
<p>
where <code>u(x,t)</code> denotes the temperature distribution and <code>a_T</code> is the thermal diffusivity. The boundary conditions are written in the general form
</p>
